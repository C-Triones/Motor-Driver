...
*********************************************************************************************************
*/
void bsp_SetTIMOutPWM(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, TIM_TypeDef* TIMx,\
    uint8_t _ucChannel,uint32_t _ulFreq, uint32_t _ulDutyCycle){
    ...
    {
        /* APB2 定时器 */
        uiTIMxCLK = SYSCLK_FREQ_72MHz;
    }
    else	/* APB1 定时器 */
    {
        uiTIMxCLK = SYSCLK_FREQ_72MHz;	// SystemCoreClock / 2;
    }
